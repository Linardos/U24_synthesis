...
def scan_test_set(test_root: Path):
    found = []
...
def main():
    ...
    samples = scan_test_set(TEST_ROOT)

    out_cview = Path(str(TEST_ROOT) + "_cview")
    out_2d = Path(str(TEST_ROOT) + "_2d")
    ...
    print("\n=== FinalImageType counts (TEST SET) ===")
