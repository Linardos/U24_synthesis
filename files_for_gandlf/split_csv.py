...
# Load the CSV file
x = "stylegan" #vqvae, stylegan etc
input_file = 'original_256_train_data.csv'
input_file = f'{x}_train_data.csv'
...
train_90.to_csv(f'{x}_0.9_train_split.csv', index=False)
val_90.to_csv(f'{x}_0.1_val_split_holdout.csv', index=False)
